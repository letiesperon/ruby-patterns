  ...
  module V1
    class CampaignsController < Api::V1::ApiController
      ...
      def create
        ...
        return unless @campaign.outbound?

        invoke_attachment_handler(@campaign.sms_engagement, sms_engagement_image_data)
        invoke_attachment_handler(@campaign.web_push_engagement, web_push_engagement_image_data)
      end
      ...
      def campaign_params
        params.require(:campaign)
              .permit(
                ...
                outbound_setting_attributes: outbound_setting_attributes,
      ...
      def outbound_setting_attributes
        [:status,
         sms_engagement_attributes:
           %i[id enabled segment_id discount_percentage discount_code
              discount_expires_in message append_legal_text_to_sms
              delivery_mode delivery_date_time applied_discount_code_to_url_shortener],
         web_push_engagement_attributes:
           %i[id enabled popup_title popup_body link
              discount_code delivery_mode delivery_date_time]]
      end
      ...
      def sms_engagement_image_data
        params.dig(:campaign, :outbound_setting_attributes, :sms_engagement_attributes, :image)
      end

      def web_push_engagement_image_data
        params.dig(:campaign, :outbound_setting_attributes, :web_push_engagement_attributes, :image)
      end
